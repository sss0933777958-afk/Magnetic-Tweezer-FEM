...
Output: ../step_for_fem/<original_name>.STEP
"""
...
HUNG_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
STEP_DIR = os.path.join(HUNG_DIR, "parts")
OUT_DIR = os.path.join(HUNG_DIR, "step_for_fem")
